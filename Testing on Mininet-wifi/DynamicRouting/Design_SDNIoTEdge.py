...
def topology():
	...
	#if wanna change range of an AP, change txpower, txpower=3dbm equals 120 m range. 
    #modify position to change the distance between each node.
    #ap1 = net.addAccessPoint('edge1',mac='00:00:00:00:00:10',position='200,200,0',inNamespace=True,dpid='1',txpower=3)
    #ap2 = net.addAccessPoint('edge2',mac='00:00:00:00:00:20',position='250,200,0',inNamespace=True,dpid='2',txpower=3)
