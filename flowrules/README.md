...
13. After getting the "dataoath-id" of all edges, copy them and paste them at [`line 58 to 64`](https://github.com/TNatapon/Privacy_SDN_Edge_IoT/blob/d61178352c897359d9477f5d834ae39588311aed/flowrules/superedge.py#L58) in the script `superedge.sh`.
